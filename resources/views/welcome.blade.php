...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="min-h-screen flex items-center justify-center">
        <div class="w-full h-screen relative bg-cover bg-center flex items-end justify-center md:items-center"
            style="background-image:url(&quot;https://images.unsplash.com/photo-1597528662465-55ece5734101?q=80&amp;w=2874&amp;auto=format&amp;fit=crop&amp;ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&quot;)">
            <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black md:bg-black md:bg-opacity-50"></div>
            <div class="relative w-full max-w-screen-md mx-auto text-start sm:text-center p-6 rounded-lg z-10">

                <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">Robado Bakery, toko roti
                    menyediakan segala jenis roti</h1>
                <p class="text-base md:text-lg text-white mb-6">Pesan langsung dari website, lebih cepat dan praktis.
                </p>
                <div class="space-y-4 md:space-y-0 md:flex md:space-x-4">
                    <a class="block w-full md:w-1/2" href="{{ route('register') }}">
                        <button
                            class="px-10 py-3 w-full bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition duration-300">Daftar
                            Berlangganan</button>
                    </a>
                    <a class="block w-full md:w-1/2" href="{{ route('dashboard.guest') }}">
                        <button
                            class="px-6 py-3 w-full bg-white text-green-500 font-semibold rounded-lg hover:bg-green-100 transition duration-300">Lewati</button>
                    </a>
                </div>
                <div class="text-white text-center mt-6">Sudah punya akun?
                    <a class="text-green-500 hover:underline" href="{{ route('login') }}">Masuk</a>
                </div>
            </div>
        </div>
    </div>
